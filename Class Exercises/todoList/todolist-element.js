        ...
        <dom-repeat 
          ...
          <template>
            <div class="task">
              ...
              <paper-input always-float-label label="Task:" value="{{task.task}}"></paper-input>
            </div>
          </template>
        </dom-repeat>
        <paper-button raised on-click="addTask"><iron-icon icon="file-download"></iron-icon>Add Task</paper-button>
        <h4>[[sub]]</h4>
        <dom-repeat 
          items={{tasks}} 
          as="task" 
